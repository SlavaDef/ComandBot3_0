...
public class BotAnswer {
    ...
    private static BanksUtil BANK = (BanksUtil) new PrivatService();
    ...
    public void botAnswerUtils(String receivedMessage, SendMessage message, String userName, MessageSender sender) {
        ...
        switch (receivedMessage) {
            ...
            case "/Private":
                ...
                BANK = (BanksUtil) new PrivatService();
                break;
            case "/Mono":
                MESSAGE_MENU.returnMenu(message, "Монобанк");
                BANK = (BanksUtil) new MonobankService();
                break;
            case "/NBU":
                MESSAGE_MENU.returnMenu(message, "Банк НБУ");
                BANK = (BanksUtil) new NBUService();
                break;
            case "/USD":
                isUsd = !isUsd;
                break;
